...
<?php
		...
		$_SESSION["date"]=$date;
		$_SESSION["products"]=$totalFieldCount;
		//$_SESSION["products"]=$products; from dailypurchase.php
		$_SESSION["Item"]=$Item;
...
<br><button class="btn btn-default"><a href="Dailypurchase_alter.php" style="text-decoration:none">Modify</a></button>
