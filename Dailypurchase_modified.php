...
<div class="containe">
	...
	<div class="panel">  
		...
		<td><input id="Price0" type="number" name="Price[]" required="" onkeyup="sum();"></td>
					...
					<a class="remove_input" id="remove_input"></a>

				<a id="add_another" class="add_another"></a>

				<input type="hidden" name="totalFieldCount" id="totalFieldCount" value="">
...
//select date then only body will be displayed
...
$(document).ready(function(){
...

         	{
         		...
         		if (!document.getElementById("dynamic_row")) {



         		

         		$("#dataTable").append('<thead><tr><th class="text-center1">Item name</th><th title="in kilo gram" class="text-center1">Wght/Qty</th><th class="text-center1">Price</th></tr></thead><tbody id="dynamic_row"><tr><td><input type="text" name="Item[]" required title="Do not include Numbers in Item name" ></td><td><input type="number" step="any" name="Quantity[]" required="" id=Quantity></td><td><input id="Price0" type="number" name="Price[]" required="" onkeyup="sum();"></td></tr></tbody>');



         		$("#add_another").append('<span>Add</span>');

         		$("#settle").append('<p class="total">'+'Total Amount: '+'<i class="fa fa-inr" aria-hidden="true">'+'</i>'+' <input type="text" id="total" name="total" readonly >'+'</p>'+'<hr class="ruler">'+

        '<div class=text-center>'+

'<button name="entry" onmouseover="Validate()" class="btn btn-primary btn-sm">'+'Submit'+'</button>'+'</div>'+'<br>');
...
$(function() {
  ...
  var i = document.getElementsByName("Price[]").length;
     ...
     $("#dynamic_row").append(
		...
		'<td>'+'<input type="text" name="Item[]" required title="Do not include Numbers in Item name" >'+'</td>'+

		'<td>'+'<input type="number" step="any" name="Quantity[]" required="" id=Quantity>'+'</td>'+
 ...
 document.getElementById("remove_input").innerHTML = "Remove";
...
//   var all = document.getElementsByName("Price[]").length;  	
...
// });
  ...
  $('.remove_input').on("click", function(){
    ...
    $('#dynamic_row tr:last').remove();

     var all = document.getElementsByName("Price[]").length;  	

  	if (all == 1) {

  		document.getElementById("remove_input").innerHTML = "";
...
/*Disable form submit while press enter in No.of Items */
...

	{
		...
		var totalField = document.getElementsByName("Price[]").length;

		document.getElementById("totalFieldCount").setAttribute("value", totalField);
