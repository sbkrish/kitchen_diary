...
<!--<form align="right" name="form1" method="post" action="logout.php">
  ...
  <button name="Daily" onclick="location.href='Dailypurchase_modified.php'" class="Prior"><div class="fon"><i class="fa fa-cart-plus" aria-hidden="true"></i></div> Daily Purchase Entry</button>
